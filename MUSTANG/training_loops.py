...
def train_att_slides(embedding_net, classification_net, patients_TRAIN, patients_TEST, train_ids, test_ids, loss_fn, optimizer, embedding_vector_size, n_classes, bag_weight,  num_epochs=1):
...
def train_att_multi_slide(embedding_net, classification_net, train_ids, test_ids, CD138_patients_TRAIN, CD68_patients_TRAIN, CD20_patients_TRAIN, HE_patients_TRAIN, CD138_patients_TEST, CD68_patients_TEST, CD20_patients_TEST, HE_patients_TEST, loss_fn, optimizer, embedding_vector_size, n_classes, bag_weight,  num_epochs=1, training=True, testing=True):
    ...
    np_best_acc = best_acc.detach().to('cpu').numpy()
    ...
    return embedding_net, classification_net, np_best_acc
