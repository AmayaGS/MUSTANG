# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 18:59:05 2023
...
sys.stdout = open("/data/home/wpw030/MangoMIL/results/GCN_SAGPool_multi_stain_results.txt", 'w')

if train_slides:
        
    classification_weights = "/data/scratch/wpw030/RA/weights/GCN_SAGPool_multi_graph_classification.pth"
    
    embedding_net = VGG_embedding(embedding_vector_size=embedding_vector_size, n_classes=n_classes)
    graph_net = GCN_SAGPool(1024) 
