...
if train_slides:
    ...
    for train_stain, test_stain in zip(patient_stain_train, patient_stain_test):
        ...
        classification_weights = "/data/scratch/wpw030/RA/weights/CLAM_" + key + ".pth"
        ...
        _, classification_model = train_att_slides(embedding_net, classification_net, train_stain, test_stain, train_ids, test_ids, loss_fn, optimizer_ft, embedding_vector_size, n_classes=n_classes, bag_weight=0.7, num_epochs=50)
