...
class GCN_SAGPool(torch.nn.Module):
    ...
    def __init__(self, dim_in, heads=1, pooling_ratio=0.5):
        ...
        self.gat1 = GCN2Conv(dim_in, 512, heads=1)
        self.gat2 = GCN2Conv(512*heads, 512, heads=1)
        self.gat3 = GCN2Conv(512*heads, 512, heads=1)
        self.gat4 = GCN2Conv(512*heads, 512, heads=1)
