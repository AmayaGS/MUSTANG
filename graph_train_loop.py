...
def train_graph_slides(embedding_net, graph_net, patients_TRAIN, patients_TEST, train_ids, test_ids, loss_fn, optimizer, embedding_vector_size, n_classes, num_epochs=1):
    ...
    return embedding_net, graph_net


# %%


def train_graph_multi_stain(embedding_net, graph_net, CD138_patients_TRAIN, CD68_patients_TRAIN, CD20_patients_TRAIN, HE_patients_TRAIN, CD138_patients_TEST, CD68_patients_TEST, CD20_patients_TEST, HE_patients_TEST, train_ids, test_ids, loss_fn, optimizer, K, embedding_vector_size, n_classes, num_epochs=1, training=True, testing=True, random_seed=str(2), heads=str(1), pooling_ratio=str(0.5), learning_rate=str(0.0001), checkpoints="PATH_checkpoints"):
        ...
        if testing:
            ...
            if val_accuracy >= best_acc:
                if val_auc >= best_AUC:
                    ...
                    best_AUC = val_auc
                    checkpoint_weights = PATH_checkpoints + random_seed + "_" + heads + "_" + pooling_ratio + "_" + learning_rate + "_checkpoint_" + str(epoch) + ".pth"    
