...
def train_graph_multi_stain(graph_net, train_loader, test_loader, loss_fn, optimizer, K, embedding_vector_size, n_classes, num_epochs=1, training=True, testing=True, checkpoint=True, checkpoint_path="PATH_checkpoints"):
