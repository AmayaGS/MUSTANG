...
def train_clam_multi_wsi(clam_net, train_loader, test_loader, loss_fn, optimizer, n_classes, bag_weight, num_epochs=1, training=True, testing=True, checkpoint=True, checkpoint_path="PATH_checkpoints"):
